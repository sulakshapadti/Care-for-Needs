...
$sql_query="INSERT INTO forestration(firstname,lastname,gender,age,phone,adress,animal,subject)

VALUES

('$firstname', '$lastname', '$gender', '$age', '$phone','$adress','$animal','$subject')";
...
<h2>"LOVE THE EARTH AS YOU WOULD LOVE YOURSELF"</h2>

<div class="navbar">
  <a href="#" class="active">Home</a>
  <a href="forestationd.php">Show Details</a>
...
<section>
   ...
   <img class="mySlides" src="img/tree1.png" style="width:100%">
  <img class="mySlides" src="img/tree2.png" style="width:100%">
  <img class="mySlides" src="img/tree3.png" style="width:100%">
</section>
...
function carousel() {
  ...
  setTimeout(carousel, 3000);
    ...
    <div class="column">
      <form action="forestrationphp.php" method="post">
        <label for="fname">First Name of a native person</label>
...
<input type="radio" id="gender" name="gender" value="male">male</td><br><br>
  ...
  <small>Format: 123-45-678</small><br><br>
        ...
        <input type="text" id="adress" name="adress" placeholder="where our people should reach">
        <label for="animal">Animal that has to be rescued </label>
